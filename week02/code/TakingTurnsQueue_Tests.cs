...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found:
    // The queue doesn't maintain the correct order when re-enqueuing people
    ...
    // Defect(s) Found: The queue fails to maintain correct order when a new people is added
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The code does not correctly handle people with 0 turns (infinite turns)
    ...
    // Defect(s) Found: The code doesn't correctly handle people with negative turns (infinite turns).
