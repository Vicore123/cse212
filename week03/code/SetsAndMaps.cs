...
public static class SetsAndMaps
{
    ...
    public static bool IsAnagram(string word1, string word2)
    {
        ...
        foreach (char characte in word1)
        {
            if (letters.ContainsKey(characte))
                letters[characte]++;
            else
                letters.Add(characte, 1);
        }

        foreach (char characte in word2)
        {
            if (!letters.ContainsKey(characte))
                return false;
